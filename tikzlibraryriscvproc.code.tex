...
\ctikzset{processor/memory/smallwidth/.initial=0.4}
\ctikzset{processor/memory/smallheight/.initial=0.8}
\ctikzset{processor/misc/slope/.initial=15}
\ctikzset{processor/control/height/.initial=4}
\ctikzset{processor/control/width/.initial=1.3}
\ctikzset{processor/control/radius/.initial=0.25}
\ctikzset{processor/alu/height/.initial=1.5}
\ctikzset{processor/alu/width/.initial=1}
...
\pgfdeclareshape{extend}{
	...
	\anchor{ctrl}{
		\northwest
		\pgfmathparse{0.5*(\pgf@y + \bigheight)}
...
\pgfdeclareshape{alu}{
	...
	\savedanchor\northwest{
		\pgfmathsetlength{\pgf@circ@scaled@Rlen}{\ctikzvalof{\ctikzclass/scale}*\pgf@circ@Rlen}
		\pgf@y=\ctikzvalof{processor/alu/height}\pgf@circ@scaled@Rlen
		\pgf@y=.5\pgf@y
		\pgf@x=-\ctikzvalof{processor/alu/width}\pgf@circ@scaled@Rlen
		\pgf@x=.5\pgf@x
	}
	...
	\pgfmathsetlengthmacro{\cutinheight}{-0.25*\ctikzvalof{processor/alu/width}\pgf@circ@scaled@Rlen*tan(\slopeval)}
...
\pgfdeclareshape{adder}{
	...
	\pgf@circ@draw@component{
		...
		%draw text
		\pgf@circ@text@strokecolor
		\pgftext[center,x=0pt,y=0pt]{\textbf{+}}
	}
}
...
\pgfdeclareshape{mux}{
	...
	\pgf@circ@draw@component{
		...
		\pgfpathmoveto{\pgfpoint{0pt}{\pgf@circ@res@up + \pgf@circ@res@step}}
		\pgfpathlineto{\pgfpoint{2*\pgf@circ@res@right}{\pgf@circ@res@up}}
		\pgfpathlineto{\pgfpoint{2*\pgf@circ@res@right}{\pgf@circ@res@down}}
		\pgfpathlineto{\pgfpoint{0pt}{\pgf@circ@res@down-\pgf@circ@res@step}}
		\pgfpathclose
...
\pgfdeclareshape{ctrlunitsc}{
	...
	\savedanchor\northwest{
		\pgfmathsetlength{\pgf@circ@scaled@Rlen}{\ctikzvalof{\ctikzclass/scale}*\pgf@circ@Rlen}
		\pgf@y=\ctikzvalof{processor/control/height}\pgf@circ@scaled@Rlen
		\pgf@y=.5\pgf@y % take half height
		\pgf@x=-\ctikzvalof{processor/control/width}\pgf@circ@scaled@Rlen
		\pgf@x=.5\pgf@x % take half width
	}
	...
	\pgf@circ@draw@component{
		...
		\newdimen\pgf@circ@res@radius
		\pgf@circ@res@radius = \ctikzvalof{processor/control/radius}\pgf@circ@scaled@Rlen
		...
		\pgfsetcornersarced{\pgfpoint{\pgf@circ@res@radius}{\pgf@circ@res@radius}}
		...
		% op
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@left - \pgf@circ@res@leadlen}{0pt}}
		\pgfpathlineto{\pgfpoint{\pgf@circ@res@left}{0pt}}
		% funct3
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@left-\pgf@circ@res@leadlen}{0.25\pgf@circ@res@down}}
		\pgfpathlineto{\pgfpoint{\pgf@circ@res@left}{0.25\pgf@circ@res@down}}
		% funct7
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@left-\pgf@circ@res@leadlen}{0.5\pgf@circ@res@down}}
		\pgfpathlineto{\pgfpoint{\pgf@circ@res@left}{0.5\pgf@circ@res@down}}
		
		% zero
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@left-\pgf@circ@res@leadlen}{0.75\pgf@circ@res@down}}
		...
		% pcsrc
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@right+\pgf@circ@res@leadlen}{0.75\pgf@circ@res@up}}
		\pgfpathlineto{\pgfpoint{\pgf@circ@res@right-\pgf@circ@res@other}{0.75\pgf@circ@res@up}}
		% resultsrc
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@right+\pgf@circ@res@leadlen}{0.5\pgf@circ@res@up}}
		\pgfpathlineto{\pgfpoint{\pgf@circ@res@right-\pgf@circ@res@other}{0.5\pgf@circ@res@up}}
		% memwrite
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@right+\pgf@circ@res@leadlen}{0.25\pgf@circ@res@up}}
		\pgfpathlineto{\pgfpoint{\pgf@circ@res@right-\pgf@circ@res@other}{0.25\pgf@circ@res@up}}
		% alucontrol
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@right+\pgf@circ@res@leadlen}{0pt}}
		\pgfpathlineto{\pgfpoint{\pgf@circ@res@right-\pgf@circ@res@other}{0pt}}
		% alusrc
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@right+\pgf@circ@res@leadlen}{0.25\pgf@circ@res@down}}
		\pgfpathlineto{\pgfpoint{\pgf@circ@res@right-\pgf@circ@res@other}{0.25\pgf@circ@res@down}}
		% immsrc
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@right+\pgf@circ@res@leadlen}{0.5\pgf@circ@res@down}}
		\pgfpathlineto{\pgfpoint{\pgf@circ@res@right-\pgf@circ@res@other}{0.5\pgf@circ@res@down}}
		% regwrite
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@right+\pgf@circ@res@leadlen}{0.75\pgf@circ@res@down}}
