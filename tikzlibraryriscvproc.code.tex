...
\ctikzset{processor/control/radius/.initial=5}				% border radius fo control units
...
\long\def\pgfcirc@declare@arith#1#2#3#4{% #1 name, #2 zero signal, #3 ctrl signal, #4 label
	\pgfdeclareshape{#1}{
		...
		\pgf@circ@draw@component{
			...
			%draw text
			\pgf@circ@text@strokecolor
			\pgftext[center,x=0.25\pgf@circ@res@right,y=0pt]{\customfont \textbf{#4}}
		}
	}
...
\pgfcirc@declare@arith{subtr}{0}{0}{-}
