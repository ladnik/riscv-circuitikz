...
\usepackage[left=2cm,right=2cm,top=2.5cm,bottom=2cm,headheight=1cm]{geometry} % Page margins
...
\renewcommand{\familydefault}{\sfdefault} % set font to sans seri
...
\begin{verbatim}
	...
	...
\end{verbatim}
If you aim for the same look as in this document, adjust fonts and colors accordingly. Note that these settings have global scope. If you wish to adjust them only for a single \texttt{tikzpicture} or \texttt{circuitikz} environment, pass it there.
\begin{verbatim}
	\ctikzset{processor/font=\fontsize{10}{12}\fontfamily{lmss}\selectfont}
	\tikzset{font=\fontsize{10}{12}\fontfamily{lmss}\selectfont}
	\definecolor{modblue}{HTML}{288DCC}
