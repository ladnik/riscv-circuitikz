...
\ctikzset{processor/thickness/.initial=1}					% line width of all components
\ctikzset{processor/leadthickness/.initial=1}				% line width of all leads
\def\pgfcirc@processor@font{\fontsize{10}{12}\fontfamily{lmss}\selectfont}
\ctikzset{processor/font/.store in=\pgfcirc@processor@font}	% set font for component labels

% \processorfont starts every \pgftext label. The label color is the PDF fill color set by
% \pgf@circ@text@strokecolor, but LaTeX's own current color is not updated by that, so box
% constructs like \textsubscript (an \sbox) would fall back to the outer color (black).
% Sync it inside the label box before selecting the font.
\def\processorfont{%
	\pgfutil@ifundefined{\string\color@pgffillcolor}{}{\pgfutil@color{pgffillcolor}}%
	\pgfcirc@processor@font
}
...
\newif\ifpgfcirc@draw@zero\pgfcirc@draw@zerotrue
\ctikzset{processor draw zero/.is choice}
\ctikzset{processor draw zero/true/.code={\pgfcirc@draw@zerotrue}}
\ctikzset{processor draw zero/false/.code={\pgfcirc@draw@zerofalse}}
\tikzset{zero/.code={\pgfcirc@draw@zerotrue}}
\tikzset{no zero/.code={\pgfcirc@draw@zerofalse}}
...
\pgfdeclareshape{instrmem}{
	...
	\pgf@circ@draw@component{
		...
		% draw shape
		\pgfscope
		\pgfsetlinewidth{\ctikzvalof{processor/thickness}}
		...
		\pgfscope
		\pgfsetlinewidth{\ctikzvalof{processor/leadthickness}}
		...
		\pgftext[left,x=0.9\pgf@circ@res@left,y=0.5\pgf@circ@res@up]{\processorfont A}
		\pgftext[right,x=0.9\pgf@circ@res@right,y=0.5\pgf@circ@res@up]{\processorfont RD}
		\endpgfscope
	}
}
...
\pgfdeclareshape{datamem}{
	...
	\pgf@circ@draw@component{
		...
		\pgftext[left,x=0.9\pgf@circ@res@left,y=0.5\pgf@circ@res@up]{\processorfont A}
		\pgftext[right,x=0.9\pgf@circ@res@right,y=0.5\pgf@circ@res@up]{\processorfont RD}
		\pgftext[center,x=0.5\pgf@circ@res@right,y=0.85\pgf@circ@res@up]{\processorfont WE}
		\pgftext[left,x=0.9\pgf@circ@res@left,y=0.6\pgf@circ@res@down]{\processorfont WD}
...
\pgfdeclareshape{regfile}{
	...
	\pgf@circ@draw@component{
		...
		%draw text
		\pgf@circ@text@strokecolor
		\pgftext[left,x=0.9\pgf@circ@res@left,y=0.6\pgf@circ@res@up]{\processorfont A1}
		\pgftext[left,x=0.9\pgf@circ@res@left,y=0pt]{\processorfont A2}
		\pgftext[left,x=0.9\pgf@circ@res@left,y=0.3\pgf@circ@res@down]{\processorfont A3}
		\pgftext[left,x=0.9\pgf@circ@res@left,y=0.6\pgf@circ@res@down]{\processorfont WD3}

		\pgftext[right,x=0.9\pgf@circ@res@right,y=0.6\pgf@circ@res@up]{\processorfont RD1}
		\pgftext[right,x=0.9\pgf@circ@res@right,y=0pt]{\processorfont RD2}

		\pgftext[center,x=0,y=0.85\pgf@circ@res@up]{\processorfont WE3}
	}
}
	...
	\pgf@circ@draw@component{
		...
		\ifpgfcirc@draw@enable@input
			\ifpgfcirc@draw@clear@input
				\pgftext[bottom,x=0pt,y=\pgf@circ@res@down+5pt, rotate=90]{\processorfont \scriptsize EN}
			\else
				\pgftext[bottom,x=0pt,y=\pgf@circ@res@down+2pt]{\processorfont \scriptsize EN}
			\fi
		\fi

		\ifpgfcirc@draw@clear@input
			\pgftext[bottom,x=5pt,y=\pgf@circ@res@down+7.25pt, rotate=90]{\processorfont \scriptsize CLR}
		\fi
	}
}
...
\long\def\pgfcirc@declare@arith#1#2#3#4{% #1 name, #2 zero signal, #3 ctrl signal, #4 label
	\pgfdeclareshape{#1}{
		...
		\pgf@circ@draw@component{
			...
			%draw text
			\pgf@circ@text@strokecolor
			\pgftext[center,x=0.25\pgf@circ@res@right,y=0pt]{\processorfont #4}
		}
	}
...
\pgfdeclareshape{mux}{
	...
	\pgf@circ@draw@component{
		...
		%draw text
		\pgf@circ@text@strokecolor
		\pgftext[center,x=0pt,y=0.5\pgf@circ@res@up]{\processorfont 0}
		\pgftext[center,x=0pt,y=0.5\pgf@circ@res@down]{\processorfont 1}
	}
}
...
\pgfdeclareshape{3mux}{
	...
	\pgf@circ@draw@component{
		...
		%draw text
		\pgf@circ@text@strokecolor
		\pgftext[center,x=0pt,y=0.6\pgf@circ@res@up]{\processorfont 00}
		\pgftext[center,x=0pt,y=0pt]{\processorfont 01}
		\pgftext[center,x=0pt,y=0.6\pgf@circ@res@down]{\processorfont 10}
	}
}
...
\pgfdeclareshape{4mux}{
	...
	\pgf@circ@draw@component{
		...
		%draw text
		\pgf@circ@text@strokecolor
		\pgftext[center,x=0pt,y=0.75\pgf@circ@res@up]{\processorfont 00}
		\pgftext[center,x=0pt,y=0.25\pgf@circ@res@up]{\processorfont 01}
		\pgftext[center,x=0pt,y=0.25\pgf@circ@res@down]{\processorfont 10}
		\pgftext[center,x=0pt,y=0.75\pgf@circ@res@down]{\processorfont 11}
	}
}
...
\long\def\pgfcirc@declare@ctrlunit#1#2{% #1 name, #2 sc (0) vs mc (1) vs pl (2)
	\pgfdeclareshape{#1}{
		...
		\pgf@circ@draw@component{
			...
			%draw text
			\pgf@circ@text@strokecolor
			\pgftext[left,x=0.9\pgf@circ@res@left,y=0pt]{\processorfont op}
			\pgftext[left,x=0.9\pgf@circ@res@left,y=0.25\pgf@circ@res@down]{\processorfont funct3}
			\pgftext[left,x=0.9\pgf@circ@res@left,y=0.5\pgf@circ@res@down]{\processorfont funct7\textsubscript{5}}

			\ifnum#2<2
				\ifpgfcirc@draw@zero
                    \pgftext[left,x=0.9\pgf@circ@res@left,y=0.75\pgf@circ@res@down]{\processorfont zero}
                \fi
			\fi
		}
	}
